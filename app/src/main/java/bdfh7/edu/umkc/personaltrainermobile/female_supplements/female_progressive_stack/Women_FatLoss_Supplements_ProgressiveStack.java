 ...
 */
public class Women_FatLoss_Supplements_ProgressiveStack extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstaceState) {
        ...
        progressive_stack.add(new Supplements_GetterSetter("Weight Loss Aid Capsule", "Thermogenic", R.drawable.med1));
