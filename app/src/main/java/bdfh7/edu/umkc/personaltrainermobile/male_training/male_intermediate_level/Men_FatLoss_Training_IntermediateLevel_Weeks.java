 ...
 */
public class Men_FatLoss_Training_IntermediateLevel_Weeks extends Activity {
    ...
    private void dayTraining(View v) {
        ...
        Intent myIntent = new Intent(v.getContext(), Men_FatLoss_Training_IntermediateLevel_Days.class);
