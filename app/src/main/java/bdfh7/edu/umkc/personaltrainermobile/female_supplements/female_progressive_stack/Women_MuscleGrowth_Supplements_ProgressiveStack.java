package bdfh7.edu.umkc.personaltrainermobile.female_supplements.female_progressive_stack;
 ...
 */
public class Women_MuscleGrowth_Supplements_ProgressiveStack extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstaceState) {
        ...
        progressive_stack.add(new Supplements_GetterSetter("Lean Protein - For Her", "Protein Powder", R.drawable.med1));
        progressive_stack.add(new Supplements_GetterSetter("Women's Daily Multivitamin", "Multivitamin", R.drawable.med1));
        progressive_stack.add(new Supplements_GetterSetter("Krill Oil", "Cardiovascular Support", R.drawable.med1));
        progressive_stack.add(new Supplements_GetterSetter("Amino Acid Powder", "BCAA - Powder", R.drawable.med1));
        progressive_stack.add(new Supplements_GetterSetter("Pre-Workout Supplements", "Pre-Workout for Women", R.drawable.med1));
