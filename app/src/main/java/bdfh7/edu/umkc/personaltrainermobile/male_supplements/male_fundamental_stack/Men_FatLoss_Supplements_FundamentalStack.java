 ...
 */
public class Men_FatLoss_Supplements_FundamentalStack extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fundamental_stack.add(new Supplements_GetterSetter("Weight Loss Aid Capsule", "Thermogenic", R.drawable.med1));
