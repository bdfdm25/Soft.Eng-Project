 ...
 */
public class Men_FatLoss_Training_BeginnerLevel_Weeks extends Activity {
    ...
    private void dayTraining(View v) {
        ...
        Intent myIntent = new Intent(v.getContext(), Men_FatLoss_Training_BeginnerLevel_Days.class);
