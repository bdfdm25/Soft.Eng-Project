 ...
 */
public class Women_MuscleGrowth_Training_AdvancedLevel_Weeks extends Activity {
    ...
    private void dayTraining(View v) {
        ...
        Intent myIntent = new Intent(v.getContext(), Women_MuscleGrowth_Training_AdvancedLevel_Days.class);
