package bdfh7.edu.umkc.personaltrainermobile.male_supplements.male_advanced_stack;
 ...
 */
public class Men_MuscleGrowth_Supplements_AdvancedStack extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstaceState) {
        ...
        advanced_stack.add(new Supplements_GetterSetter("Men's Daily Multivitamin", "Multivitamin", R.drawable.med1));
        advanced_stack.add(new Supplements_GetterSetter("Creatine", "Creatine Monohydrate Powder", R.drawable.med1));
